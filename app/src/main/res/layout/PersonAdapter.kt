...
import java.io.Serializable class PersonAdapter(private val context: Context,
                                                private val
array: ArrayList<Person>):

RecyclerView.Adapter<PersonAdapter.PersonViewHolder>(){ lateinit var
...
// Initialize the databaseHelper here
    ...
    inner class PersonViewHolder(val itemView: View): RecyclerView.ViewHolder(itemView)
    {
        ...
        val emailTxt : TextView = itemView.findViewById(R.id.emailid) val
            phoneTxt : TextView = itemView.findViewById(R.id.mobile) val
            addressTxt : TextView = itemView.findViewById(R.id.address) val
            mapBtn : ImageView = itemView.findViewById(R.id.btnLocation) val
    ...
    override fun onBindViewHolder(holder: PersonViewHolder, position: Int) {
        val person = array[position] holder.nameTxt.text
        = person.name
        holder.emailTxt.text = person.emailId
        holder.phoneTxt.text = person.phoneNo
        holder.addressTxt.text = person.address val
                obj = person as Serializable
